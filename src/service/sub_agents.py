...
class CoderAgent(BaseAgent):
    ...
    def _execute_code_task(self, task: str, context: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        if "データ処理" in task:
            return {
                "code": "# データ処理のサンプルコード\ndata = [1, 2, 3, 4, 5]\nresult = sum(data)\nprint(f'合計: {result}')",
                "output": "合計: 15",
...
class CasualAgent(BaseAgent):
    ...
    def _process_casual_task(self, task: str, context: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        if "レポート" in task:
            return {
...
class FileAgent(BaseAgent):
    ...
    def _process_file_task(self, task: str, context: Optional[Dict[str, Any]]) -> Dict[str, Any]:
...
class AgentManager:
    ...
    def execute_task(self, agent_type: str, task: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
